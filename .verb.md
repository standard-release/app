...
For NPM publishing on the CI or locally, install [@tunnckocore/release-cli](https://github.com/tunnckoCore/release-cli) and just run it. You still can use it locally, but then should pass `--no-ci` flag to make it work.
